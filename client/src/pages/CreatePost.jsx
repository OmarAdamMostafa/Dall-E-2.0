  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-y-[500px]'>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
          ...
          w-64 p-3 h-64 flex justify-center items-center'>
            {
              form.photo ? (
                <img src={form.photo} alt='prompt' className='w-full h-full object-contain'/>
              ) : (
                <img src={preview} alt='preview' className='w-9/12 h-8/12 object-contain opacity-40'/>
              )
            }
